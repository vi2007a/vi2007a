...
<img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30">Started working as a Manual tester and progressed to an automation testing projects , later moved in to development projects and started working as a programmer analyst , currently working in a data project , using  python . Always keen to learn new concepts. 
